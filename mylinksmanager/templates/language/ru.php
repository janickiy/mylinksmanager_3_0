...
$language["str"]["email_for_user_add_moder"] = "Почтовое сообщения отправляемое пользователю при добавлении его ссылки на модерацию";
$language["str"]["email_for_user_add_catalog"] = "Почтовое сообщения отправляемое пользователю при добавлении его ссылки в каталог";
$language["str"]["email_for_user_hide_absense"] = "Почтовое сообщения отправляемое пользователю, если его ссылка была временно скрыта в каталоге по причине отсутствия ответной";
$language["str"]["email_for_user_hide_prohib"] = "Почтовое сообщения отправляемое пользователю, если его ссылка скрыта в каталоге по причине запрета индексации в мета тэгах и robot.txt";
$language["str"]["email_for_user_passed"] = "Почтовое сообщения отправляемое пользователю, если его ссылка не прошла проверки администратором каталога";
$language["str"]["email_for_user_remove"] = "Почтовое сообщения отправляемое пользователю, если его ссылка была удалена из каталога";
$language["str"]["email_for_user_add_new"] = "Почтовое сообщения отправляемое администратору каталога при добавлении новой ссылки";
