...
<div class="topbarmenu">
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <!-- BEGIN ROW_FOLDER -->
            <!-- IF '${FOLDER_LINK}' != '' && '${FOLDER_LINK_NAME}' != '' -->
            <td width="${COLUMNS_NUMBER}'%">
                <table border="0" class="folder">
                    <tr>
                        <td> <span class="fa fa-folder-open-o fa-2x"></span> </td>
                        <td> <a href="${FOLDER_LINK}"> ${FOLDER_LINK_NAME}</a> <span>(${NUMBERSLINKS})</span><br>
                ...
                <div class="link-row">
                    ...
                    <div class="link-col link-c50">
                        ...
                        <form action="${ACTION2}" method="post" role="form">
                            <button class="btn btn-primary"  <!-- IF '${ALERT}' == 'show' -->
                            onclick="alert('${MSG_ALERT_WAS_CHECKED}'); return false;"<!-- END IF -->
                            type="submit">${STR_BUTTON2}</button>
